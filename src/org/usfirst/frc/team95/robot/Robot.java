...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		a.addObject("Cross Rock Wall", new TimedStraightMove(0.75, 3.5));
		...
		b.addObject("Cross Rock Wall", new TimedStraightMove(0.75, 3.5));
		...
		c.addObject("Cross Rock Wall", new TimedStraightMove(0.75, 3.5));
